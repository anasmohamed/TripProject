 ...
 * @author abdullah
 */
public class TripTableConstants {
    ...
    public static final String TRIP_USER_ID_COLUMN = "USER_ID";
    public static final String TRIP_STATUS_COLUMN = "TRIP_STATUS";
    public static final String TRIP_IMAGE_COLUMN = "TRIP_IMAGE";
