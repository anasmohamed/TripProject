...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    private View addRemoveView(LayoutInflater inflater) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            paramRemove.gravity = Gravity.START | Gravity.TOP;
        } else {
            paramRemove = new WindowManager.LayoutParams(
                    WindowManager.LayoutParams.WRAP_CONTENT,
                    WindowManager.LayoutParams.WRAP_CONTENT,
...
//            add("i wish i not call you thouthent time");add("hello from the other side");
//            add("i wish i not call you thouthent time");add("hello from the other side");
//            add("i wish i not call you thouthent time");add("hello from the other side");
//            add("i wish i not call you thouthent time");add("hello from the other side");
//            add("i wish i not call you thouthent time");add("hello from the other side");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case 1/*Waiting todo*/:
                ...
                Intent intent = new Intent(FloatingWidgetService.this, SplashActivity.class);
